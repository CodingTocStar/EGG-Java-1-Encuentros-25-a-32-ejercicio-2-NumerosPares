...
public class NumerosPares {
    ...
    public static void main(String[] args) {
        ParDeNumerosService numerosAleatorios = new ParDeNumerosService();
        ParDeNumeros aletorio = new ParDeNumeros();
        
        //a)
        numerosAleatorios.CrearParDeNumeros(aletorio);
        
        //b)
        System.out.println("El numero mayor es: " + numerosAleatorios.devolverMayor(aletorio));
        
        //c)
        System.out.println("La potencia del numero mayor elevado al numero menor es: " + numerosAleatorios.calcularPotencia(aletorio));
        
        //d)
        System.out.println("La raiz cuadrada del menor numero es: " + numerosAleatorios.calculaRaiz(aletorio));
    }
